<template>
  <div class="head" v-on:drop="handleDrop" v-on:dragover="handleDragover" v-on:paste="handlePaste">
    <div>
...
export default {
  ...
  methods: {
    ...
    handlePaste: async function (e) {
      this.$emit('setImgSrc', await util.getBase64(e.clipboardData.files[0]));
    }
  }
};
</script>
